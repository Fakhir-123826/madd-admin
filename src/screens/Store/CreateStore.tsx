                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            className="mt-1 w-full rounded-md border px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-teal-400"
                        />
                    </div>
...
<div className="bg-white p-6 rounded-xl shadow-sm space-y-6">
  ...
  <div>
    ...
    <textarea
      ...
      className="mt-1 w-full rounded-md border px-3 py-2 text-sm min-h-[120px] outline-none focus:ring-2 focus:ring-teal-400"
    />
  </div>
</div>
