...
// src/pages/SubscriptionList/SubscriptionList.tsx
import { useState, useRef, useEffect } from "react";
import { FaEllipsisV } from "react-icons/fa";
...
import type { Subscription } from "../../model/susbcription/ISubscription";
import PageHeader from "../../component/PageHeader/Pageheaderfilterbar.tsx";
...
const SubscriptionList = () => {
  ...
  const handleEdit = (subscription: Subscription) => {
    // Navigate to edit page with subscription data
    navigate(`/subscription-list/edit/${subscription.id}`, { 
      state: { subscription } 
    });
  };

  const handleAddNew = () => {
    navigate("/SubscriptionList/addSubscription");
  };
