                    ...
                    <table className="w-full table-auto">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {isLoading ? (
                                ...
                                pages.map((cmsPage: any) => (
                                    <tr
                                        key={cmsPage.uuid || cmsPage.id}
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-500">
                                            {new Date(
                                                cmsPage.creation_time || cmsPage.created_at
                                            ).toLocaleDateString()}
                                        </td>
                                        ...
                                        <td className="px-6 py-4">
                                            <span
                                                className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold border ${cmsPage.is_active
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <button
                                                onClick={() =>
                                                    navigate(
                                                        `/EditCmsPage/${cmsPage.uuid || cmsPage.id}`,
                                                        {
                                                            state: {
