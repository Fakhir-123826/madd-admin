...
function MagentoAbandonedCartsList() {
  ...
  const abandonedCarts = dummyData.items || [];

  const filtered = abandonedCarts.filter((item: any) =>
        ...
        <div className="bg-gray-100 border-b px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-9 gap-6">
            ...
            <div className="lg:col-span-2">
              <div className="text-xs text-gray-500 mb-1.5 font-medium">Customer</div>
              <input type="text" placeholder="Customer" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
            </div>

            {/* Email */}
            <div className="lg:col-span-2">
              <div className="text-xs text-gray-500 mb-1.5 font-medium">Email</div>
              <input type="text" placeholder="Email" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
            </div>

            {/* Products */}
            <div>
              <div className="text-xs text-gray-500 mb-1.5 font-medium">Products</div>
              <div className="grid grid-cols-2 gap-3">
                <input type="text" placeholder="From" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
                <input type="text" placeholder="To" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
              </div>
            </div>

            {/* Quantity */}
            <div>
              <div className="text-xs text-gray-500 mb-1.5 font-medium">Quantity</div>
              <div className="grid grid-cols-2 gap-3">
                <input type="text" placeholder="From" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
                <input type="text" placeholder="To" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
              </div>
            ...
            {/* Subtotal */}
            <div>
              <div className="text-xs text-gray-500 mb-1.5 font-medium">Subtotal</div>
              <div className="grid grid-cols-2 gap-3">
                <input type="text" placeholder="From" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
                <input type="text" placeholder="To" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
              </div>
            ...
            {/* Applied Coupon */}
            <div className="lg:col-span-2">
              <div className="text-xs text-gray-500 mb-1.5 font-medium">Applied Coupon</div>
              <input type="text" placeholder="Coupon Code" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
            </div>

            {/* Created & Updated */}
            <div className="lg:col-span-2">
              <div className="text-xs text-gray-500 mb-1.5 font-medium">Created</div>
              <div className="grid grid-cols-2 gap-3">
                <input type="date" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
                <input type="date" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
              </div>
            </div>

            <div className="lg:col-span-2">
              <div className="text-xs text-gray-500 mb-1.5 font-medium">Updated</div>
              <div className="grid grid-cols-2 gap-3">
                <input type="date" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
                <input type="date" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
              </div>
            ...
            {/* IP Address */}
            <div className="lg:col-span-2">
              <div className="text-xs text-gray-500 mb-1.5 font-medium">IP Address</div>
              <input type="text" placeholder="IP Address" className="w-full px-5 py-3.5 rounded-2xl border border-gray-300 text-sm focus:border-teal-400" />
            </div>
          </div>
        </div>
      )}
        ...
        <table className="w-full min-w-[1200px]">
          <thead>
            <tr className="bg-gradient-to-r from-teal-400 to-emerald-500">
              ...
              <th className={thClass}>Applied Coupon</th>
            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((item: any, idx: number) => (
                ...
                >
                  ...
                  <td className={tdClass}>{item.products}</td>
                  <td className={tdClass}>{item.quantity}</td>
                  <td className={tdClass}>${item.subtotal}</td>
                  <td className={tdClass}>{item.applied_coupon || "-"}</td>
                  <td className={tdClass}>{item.created_at}</td>
                  <td className={tdClass}>{item.updated_at}</td>
                  <td className={tdClass}>{item.ip_address}</td>
                </tr>
              ))
            )}
          </tbody>
...
export default MagentoAbandonedCartsList;