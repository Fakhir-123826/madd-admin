...
function MagentoOrderUpdatedReportList() {
  ...
  const toggleAll = () => {
    setSelected(
      selected.length === orders.length ? [] : orders.map((i: any) => i.id)
    );
  };
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
      ...
      {/* HEADER with Search Bar & Toggle Buttons */}
        ...
        <table className="w-full min-w-[1100px]">
          <thead>
            <tr className="bg-gradient-to-r from-teal-400 to-emerald-500">
              ...
              <th className={thClass}>Sales Items</th>
              <th className={thClass}>Sales Total</th>
              <th className={thClass}>Invoiced</th>
              <th className={thClass}>Refunded</th>
              <th className={thClass}>Sales Tax</th>
              <th className={thClass}>Sales Shipping</th>
              <th className={thClass}>Sales Discount</th>
              <th className={thClass}>Canceled</th>
            </tr>
          </thead>
          <tbody>
            {orders.length === 0 ? (
...
export default MagentoOrderUpdatedReportList;