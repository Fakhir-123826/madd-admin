...
const AddStripe: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      console.log("Saving Stripe provider:", {
        ...formData,
  ...
  return (
    <div className="min-h-screen bg-white rounded-xl p-4 md:p-8">
      <div className="w-full">
        ...
        <div className="bg-gradient-to-r from-indigo-500 to-purple-500 px-6 py-4 rounded-t-2xl flex items-center gap-4 shadow-lg">
          <button
          ...
          <h1 className="text-white font-semibold text-xl tracking-wide flex items-center gap-2">
            <SiStripe className="text-white" size={20} />
            Add Stripe Provider
          </h1>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full border-2 border-gray-200 rounded-xl px-5 py-3.5 focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 outline-none transition-all duration-200 bg-white appearance-none"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full border-2 rounded-xl px-5 py-3.5 focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 outline-none transition-all duration-200 bg-white ${
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200 w-full">
                  ...
                  <button
                    ...
                    className={`relative w-14 h-7 flex items-center rounded-full p-1 transition-all duration-300 ${
                      formData.status ? "bg-indigo-500" : "bg-gray-300"
                    }`}
                  >
                    <span
                  ...
                  <span className={`text-sm font-medium ${formData.status ? 'text-indigo-600' : 'text-gray-500'}`}>
                    Active
                  </span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200 w-full">
                  ...
                  <button
                    ...
                    onClick={toggleMode}
                    className={`relative w-14 h-7 flex items-center rounded-full p-1 transition-all duration-300 ${
                      formData.mode ? "bg-indigo-500" : "bg-gray-300"
                    }`}
                  >
                    <span
                      className={`absolute bg-white w-5 h-5 rounded-full shadow-md transform transition-transform duration-300 ${
                  ...
                  <span className={`text-sm font-medium ${formData.mode ? 'text-indigo-600' : 'text-gray-500'}`}>
                    Live
                  </span>
                </div>
              </div>
            ...
            <div className="pt-4">
              <button
                ...
                className="w-full py-3.5 border-2 border-indigo-500 text-indigo-500 rounded-xl hover:bg-indigo-50 transition-all duration-200 font-medium"
              >
                Test Connection
              </button>
            </div>
            ...
            <div className="flex justify-end gap-4 pt-6 border-t border-gray-200 mt-4">
              ...
              <button
                type="submit"
                className="flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-xl hover:from-indigo-600 hover:to-purple-600 transition-all duration-300 font-medium shadow-md hover:shadow-lg"
              >
                Save Provider
              </button>
            </div>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm z-50">
          <div className="bg-white rounded-2xl p-8 w-[450px] text-center relative shadow-2xl animate-fadeIn">
            ...
            {/* Success Icon */}
            <div className="w-20 h-20 mx-auto mb-5 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 flex items-center justify-center text-white text-4xl shadow-lg">
              ✓
            </div>
            ...
            <p className="text-gray-600 mb-2 text-lg font-normal">
              <span className="font-semibold text-indigo-600">Stripe</span> has been successfully added.
            </p>
            <p className="text-gray-500 font-normal mb-4">
              You can now accept payments through Stripe.
            </p>

            {/* Progress bar */}
            <div className="w-full bg-gray-200 h-1 rounded-full mt-4 overflow-hidden">
              <div className="bg-gradient-to-r from-indigo-500 to-purple-500 h-1 rounded-full animate-progress"></div>
            </div>
